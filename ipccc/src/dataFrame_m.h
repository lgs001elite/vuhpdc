 ...
 *     int msgMark;         // the start and end marks of  the packets sequence
 *     int pairMark;        // indicate if node ia paired
 *     int roundMark;       // to decide when the simulation ends
...
class metaFrame : public ::omnetpp::cPacket
{
  ...
  public:
    ...
    virtual int getMsgMark() const;
    virtual void setMsgMark(int msgMark);
    virtual int getPairMark() const;
    virtual void setPairMark(int pairMark);
    virtual int getRoundMark() const;
    virtual void setRoundMark(int roundMark);
