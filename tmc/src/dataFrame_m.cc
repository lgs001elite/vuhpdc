...
int metaFrameDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='c' && strcmp(fieldName, "chargeSlot")==0) return base+9;
    if (fieldName[0]=='e' && strcmp(fieldName, "endTrans")==0) return base+10;
    if (fieldName[0]=='s' && strcmp(fieldName, "sendTime")==0) return base+11;
...
std::string metaFrameDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 9: return long2string(pp->getChargeSlot());
        case 10: return long2string(pp->getEndTrans());
        case 11: return simtime2string(pp->getSendTime());
        default: return "";
    }
}
...
bool metaFrameDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 9: pp->setChargeSlot(string2long(value)); return true;
        case 10: pp->setEndTrans(string2long(value)); return true;
        case 11: pp->setSendTime(string2simtime(value)); return true;
